  ...
  dataArray: [
    {
      ...
      isText: false,
      size: "30 20",
      _data: { category: "actividad" },
    },
    {
      category: PaletteCategory.gateway,
      text: "",
      tooltip: "tooltip.gateway.main",
      gatewayType: GatewayType.general,
      isText: false,
      size: "20 20",
      _data: { category: "puertaEnlace" },
    },
    {
      ...
      size: "20 20",
      sizeInner: "17 17",
      _data: { category: "eventoIntermedio" },
    },
  ],
};
  ...
  dataArray: [
    {
      category: "laneUp",
      text: "",
      tooltip: "tooltip.lane.up",
      _data: { category: "anadirRachaArriba", position: "top" },
    },
    {
      category: "laneDown",
      text: "",
      tooltip: "tooltip.lane.down",
      _data: { category: "anadirRachaAbajo", position: "bottom" },
    },
    {
      category: "div2",
      text: "",
      tooltip: "tooltip.pool.div2",
      _data: { category: "dividirEnDosCarriles", quantity: 2 },
    },
    {
      category: "div3",
      text: "",
      tooltip: "tooltip.pool.div3",
      _data: { category: "dividirEnTresCarriles", quantity: 3 },
    },
    {
      category: PaletteCategory.annotation,
      text: "",
      tooltip: "tooltip.note.main",
      isText: false,
      size: "20 20",
      _data: { category: "anotacion" },
    },
    {
      category: "conexion",
      text: "",
      tooltip: "tooltip.conector.main",
      _data: { category: "opcionDeConexion" },
    },
    {
      category: PaletteCategory.event,
      text: "",
  ...
  dataArray: [
    {
      category: "delete",
      text: "",
      tooltip: "tooltip.delete.main",
      _data: { category: "opcionDeEliminar" },
    },
    {
      category: "properties",
      text: "",
      tooltip: "tooltip.properties.main",
      _data: { category: "propiedades" },
    },
    {
      category: "conversion",
      text: "",
      tooltip: "tooltip.conversion.main",
      size: "17 17",
      _data: { category: "opcionDeConversion" },
    },
    {
      category: "eventoBorde",
      tooltip: "tooltip.event.border",
      size: "20 20",
      _data: { category: "opcionAgregarEventoBorde" },
    },
  ],
};
