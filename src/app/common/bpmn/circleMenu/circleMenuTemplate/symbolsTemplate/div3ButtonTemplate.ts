...
export function div3ButtonTemplate(go: any, $: any, circleMenu: CircleMenu) {
  let template = $(
    "Button",
    ...
    $(
      ...
      $(go.Shape, "Process", {
        ...
        width: BpmnScriptConfig.SwinTreeNodoConversionWidth,
        height: BpmnScriptConfig.SwinTreeNodoConversionHeight,
