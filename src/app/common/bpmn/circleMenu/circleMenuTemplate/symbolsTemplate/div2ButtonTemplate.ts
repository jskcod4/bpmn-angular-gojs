...
export function div2ButtonTemplate(go: any, $: any, circleMenu: CircleMenu, Type: string){
      ...
      $(go.Shape, 'Process',
        {
          ...
          width: BpmnScriptConfig.SwinTwoNodoConversionWidth, height: BpmnScriptConfig.SwinTwoNodoConversionHeight,
