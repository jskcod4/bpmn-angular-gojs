...
export function laneDownButtonTemplate(go: any, $: any, circleMenu: CircleMenu, Type: string){
    ...
    $(go.Shape, 'Rectangle',
      {
        ...
        width: BpmnScriptConfig.LaneNodoConversionWidth, height: BpmnScriptConfig.LaneNodoConversionHeight
      }),
    $(go.Shape,
      {
        geometryString: BpmnScriptConfig.ShapeArrowDown,
        stroke: BpmnScriptConfig.LaneArrowStroke,
        width: 10, height: 15,
      }
    ),
