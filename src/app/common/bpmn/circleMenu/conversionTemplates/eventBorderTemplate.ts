...
export function eventBorderTemplete(go: any, $: any, circleMenu: CircleMenu, config: BpmnConfig): go.Adornment{

  const palNodeTemplateMap = new go.Map();
  palNodeTemplateMap.add('boundary', eventButtonTemplate(go, $, circleMenu, 'evenBorder', config));
  ...
  return $(go.Adornment, "Spot",
    ...
    $(go.Panel, "Horizontal",
      ...
      $(go.Panel, "Auto",
        ...
        $(go.Panel, "Horizontal",
          { defaultStretch: go.GraphObject.Vertical ,alignment: go.Spot.Bottom, alignmentFocus: go.Spot.Top, padding: 5,
            itemArray: circleMenu.eventBorderDataButton,
