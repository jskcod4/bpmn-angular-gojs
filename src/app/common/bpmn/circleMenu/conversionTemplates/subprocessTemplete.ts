...
export function subprocessTemplete(go: any, $: any, circleMenu: CircleMenu, config: BpmnConfig): go.Adornment{

  const palNodeTemplateMap = new go.Map();
  palNodeTemplateMap.add('subprocess', subprocessButtonTemplate(go, $, circleMenu, 'conversion', config));
