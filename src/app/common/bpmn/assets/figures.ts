...
export class FigureParameter {
   ...
   */
  public static getFigureParameter(
    figurename: string,
    index: number
  ): FigureParameter | null {
   ...
   */
  public static setFigureParameter(
    figurename: string,
    index: number,
    ...
    let arr: Array<FigureParameter> =
      FigureParameter.definedParameters[figurename];
    if (!arr) {
      // arr = [];
...
go.Shape.defineFigureGenerator("AsteriskLine", (shape, w, h) => {
  ...
  return new go.Geometry().add(
    new go.PathFigure(offset * w, (1 - offset) * h, false)
      .add(
        new go.PathSegment(go.PathSegment.Line, (1 - offset) * w, offset * h)
      )
...
go.Shape.defineFigureGenerator("Pentagon", (shape, w, h) => {
  ...
  for (let i = 1; i < 5; i++) {
    fig.add(
      new go.PathSegment(go.PathSegment.Line, points[i].x * w, points[i].y * h)
    );
  }
  fig.add(
    new go.PathSegment(
...
go.Shape.defineFigureGenerator("SquareIBeam", (shape, w, h) => {
  ...
  fig.add(
    new go.PathSegment(go.PathSegment.Line, (0.5 + param1 / 2) * w, param1 * h)
  );
  fig.add(
    new go.PathSegment(
      go.PathSegment.Line,
...
go.Shape.defineFigureGenerator("YinYang", (shape, w, h) => {
  ...
  fig.add(
    new go.PathSegment(go.PathSegment.Move, (centerx + radius) * w, centery * h)
  );
  fig.add(
    new go.PathSegment(
      go.PathSegment.Arc,
...
go.Shape.defineFigureGenerator("NotAllowed", (shape, w, h) => {
  ...
  fig.add(
    new go.PathSegment(go.PathSegment.Line, endOfArrow.x * w, endOfArrow.y * h)
  );
  fig.add(
    new go.PathSegment(
      go.PathSegment.Bezier,
...
go.Shape.defineFigureGenerator("GenderMale", (shape, w, h) => {
  ...
  fig.add(
    new go.PathSegment(go.PathSegment.Line, 0.85 * w, startOfArrow.y * 0.1 * h)
  );
...
go.Shape.defineFigureGenerator("Junction", (shape, w, h) => {
  ...
  fig2.add(
    new go.PathSegment(go.PathSegment.Move, small * w, (small + dist) * h)
  );
  fig2.add(
    new go.PathSegment(go.PathSegment.Line, (small + dist) * w, small * h)
  );
  return geo;
});
...
go.Shape.defineFigureGenerator("OfflineStorage", (shape, w, h) => {
  ...
  geo.add(fig2);
  fig2.add(
    new go.PathSegment(go.PathSegment.Line, (1 - 0.5 * param1) * w, param1 * h)
  );
...
go.Shape.defineFigureGenerator("Fallout", (shape, w, h) => {
  ...
  // Containing circle
  fig.add(
    new go.PathSegment(go.PathSegment.Arc, 180, 360, w / 2, h / 2, w / 2, h / 2)
  );
...
go.Shape.defineFigureGenerator("Caution", (shape, w, h) => {
  ...
  geo.add(fig);
  fig.add(
    new go.PathSegment(go.PathSegment.Bezier, 0.1 * w, 0.8 * h, 0, h, 0, h)
  );
  ...
  fig.add(
    new go.PathSegment(go.PathSegment.Move, (0.5 - radius) * w, 0.875 * h)
  );
  fig.add(
    new go.PathSegment(
      go.PathSegment.Arc,
...
go.Shape.defineFigureGenerator("CentrifugalPump", (shape, w, h) => {
  ...
  fig.add(
    new go.PathSegment(go.PathSegment.Bezier, 0.4 * w, h, 0, h, 0.4 * w, h)
  );
  fig.add(
    new go.PathSegment(
      go.PathSegment.Bezier,
...
go.Shape.defineFigureGenerator("Hand", (shape, w, h) => {
  ...
  fig.add(
    new go.PathSegment(go.PathSegment.Bezier, 0, 0.9 * h, 0.435 * w, h, 0, h)
  );
  fig.add(new go.PathSegment(go.PathSegment.Line, 0, 0.5 * h));
  return geo;
});
...
go.Shape.defineFigureGenerator("Building", (shape, w, h) => {
  ...
  fig2.add(
    new go.PathSegment(go.PathSegment.Line, 0.322 * w, 0.85 * h).close()
  );
  ...
  fig3.add(
    new go.PathSegment(go.PathSegment.Line, 0.598 * w, 0.85 * h).close()
  );
  ...
  fig4.add(
    new go.PathSegment(go.PathSegment.Line, 0.874 * w, 0.85 * h).close()
  );
  // the top inner triangle
  const fig5 = new go.PathFigure(0.5 * w, 0.1 * h, false); // is filled in our not
  geo.add(fig5);
  fig5.add(
    new go.PathSegment(go.PathSegment.Line, (0.046 + 0.15) * w, 0.3 * h)
  );
  fig5.add(
    new go.PathSegment(
      go.PathSegment.Line,
...
go.Shape.defineFigureGenerator("5Bars", (shape, w, h) => {
  ...
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * 0.184, h * (1 - 0.184)).close()
  );
  ...
  fig3.add(
    new go.PathSegment(go.PathSegment.Line, w * 0.388, h * (1 - 0.184 * 2))
  );
  ...
  geo.add(fig4);
  fig4.add(
    new go.PathSegment(go.PathSegment.Line, w * 0.408, h * (1 - 0.184 * 2))
  );
  fig4.add(
    new go.PathSegment(go.PathSegment.Line, w * 0.592, h * (1 - 0.184 * 3))
  );
  ...
  geo.add(fig5);
  fig5.add(
    new go.PathSegment(go.PathSegment.Line, w * 0.612, h * (1 - 0.184 * 3))
  );
  fig5.add(
    new go.PathSegment(go.PathSegment.Line, w * 0.796, h * (1 - 0.184 * 4))
  );
  ...
  geo.add(fig6);
  fig6.add(
    new go.PathSegment(go.PathSegment.Line, w * 0.816, h * (1 - 0.184 * 4))
  );
...
go.Shape.defineFigureGenerator("PC", (shape, w, h) => {
  ...
  fig3.add(
    new go.PathSegment(go.PathSegment.Line, w * 0.055, h * 0.16).close()
  );
  ...
  fig4.add(
    new go.PathSegment(go.PathSegment.Line, w * 0.055, h * 0.21).close()
  );
...
go.Shape.defineFigureGenerator("FilmTape", (shape, w, h) => {
  ...
  fig.add(
    new go.PathSegment(go.PathSegment.Arc, 270, 180, w * 0, w * 0.3, w * 0.055)
  ); // left semi-circle
  fig.add(new go.PathSegment(go.PathSegment.Line, 0, h * 1));
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.08, h * 1));
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.08, h * 0.95));
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 1), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 1), h * 1)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 2), h * 1)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 2), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 3), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 3), h * 1)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 4), h * 1)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 4), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 5), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 5), h * 1)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 6), h * 1)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 6), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 7), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 7), h * 1)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 8), h * 1)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 8), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 9), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 9), h * 1)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 10), h * 1)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 10), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 11), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 11), h * 1)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 12), h * 1)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 12), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 13), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 13), h * 1)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 14), h * 1)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 14), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 15), h * 0.95)
  );
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * (0.08 + 0.056 * 15), h * 1)
  );
  ...
  fig2.add(
    new go.PathSegment(go.PathSegment.Arc, 270, -180, w * 1, w * 0.3, w * 0.055)
  ); // right semi circle
...
go.Shape.defineFigureGenerator("Terminal", (shape, w, h) => {
  ...
  fig2.add(
    new go.PathSegment(go.PathSegment.Line, w * 0.275, h * 0.25).close()
  );
...
go.Shape.defineFigureGenerator("Download", (shape, w, h) => {
  ...
  fig.add(
    new go.PathSegment(go.PathSegment.Line, w * 0, h * (1 - third)).close()
  );
  // arrow pointing down
...
go.Shape.defineFigureGenerator("Drink", (shape, w, h) => {
  ...
  fig2.add(
    new go.PathSegment(go.PathSegment.Line, w * 0.345, h * 0.97).close()
  );
